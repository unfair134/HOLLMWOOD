    ...
    if not use_finetuned_model or not adaper_paths:
        if model_LLaMA is None or isinstance(model_LLaMA, str):
            model_LLaMA = AutoModelForCausalLM.from_pretrained(
                ...
                "/data/ranyiting/.cache/modelscope/hub/AI-ModelScope/Mistral-7B-Instruct-v0.2",
...
class ChatMistral(BaseLLM):
    def __init__(self, use_finetuned_model = False,adaper_paths = None,model_name="mistral"):
...
if __name__ =="__main__":
    model_LLaMA, tokenizer_LLaMA = initialize_Mistral(use_finetuned_model=True,
                                                      adaper_paths=[
        "/data/ranyiting/code/RPA/LLaMA-Factory/saves/Mistral-7B-v0.2-Chat/lora/train_2024-04-09-03-22-05"
        ])