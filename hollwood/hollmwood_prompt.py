...
# humanity falls to this space-bred plague.
# """
TEST_PRELIMINARY_STORYLINE="守夜人威玛·罗伊斯爵士、威尔和盖瑞在长城以北追踪野人。威尔发现一群死去的野人，但当他们到达现场时，尸体已消失。罗伊斯遭遇神秘的异鬼，在一场短暂的战斗后被杀。威尔目睹了整个过程，最后被复活的罗伊斯掐住喉咙。"
...
Strictly obey the above format and do not generate any redundant content!Remember to generate the end sign  e.g. </plot_1a> </plot_2> at the end of any plot,corresponding to the begin sign e.g. <plot_1a> <plot_2>. Remember to generate "Scene:" and "Characters:" in the every plot and subplot."""
